...
Multi-agent LLM systems for laboratory automation, LIMS integration, clinical trial site selection, large scale genomic workflows, and scientific data integration. Built production systems at Genentech that replaced weeks of manual analyst work with automated, auditable workflows — with human-in-the-loop review, parameter tracking and data provenance + lineage.

**Large-Scale Distributed Processing**
Designed and operated genomic data pipelines scaling to 60,000+ parallel EC2 instances. Built FireDB and Sunrise — internal self-serve analysis platforms serving 500+ scientists and research staffacross Genentech's research organization — handling petabyte-scale genomic and clinical data.
